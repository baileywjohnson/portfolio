...
function MyStack({updateParent}:any) {
    ...
    const stackData = [
        {
            name: 'TypeScript',
            icon: <SiTypescript id="TypeScript-logo" className="itemIcon" size={30}/>,
        ...
        {
            name: 'React',
            icon: <SiReact id="React-logo" className="itemIcon" size={30}/>,
        ...
        {
            name: 'GraphQL',
            icon: <SiGraphql id="GraphQL-logo" className="itemIcon" size={30}/>,
        ...
        {
            name: 'PostgreSQL',
            icon: <SiPostgresql id="PostgreSQL-logo" className="itemIcon" size={30}/>,
            ...
            alternatives: <p id="itemAlternativesText">As for NoSQL databases, <b>MongoDB</b> is my go-to (I also have a small amount of experience with <b>Redis</b>, which sort-of fits in this category).</p>
        }
    ]
