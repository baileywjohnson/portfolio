...
const About = ({updateParent}:any) => {
    ...
    return (
        <React.Fragment>
            ...
            <p>I initially built this portfolio to compliment my resume, as somewhere I could showcase my personal projects.  What you're viewing now is the second version (source for the old version <a href="https://github.com/baileywjohnson/portfolio-old" rel="noreferrer" target="_blank">here</a>) which includes some additional content and is something I built to try to sharpen my React & UI-design skills.</p>
            <h3>What's On My Stack</h3>
            <p>Below are some of the tools I'm comfortable leveraging to build software.  While this list is non-exhaustive, it includes some of what I've been learning/using recently.</p>
            <MyStack />
            <p>I fully accept that what I'm most comfortable with may not always be the best tool for the job so I'm always open to learning something new.  Some things I'm learning right now are Golang and how to effectively use Cassandra.</p>
            <h3>More About Me</h3>
            <p>I've been a computer geek pretty much my entire life (as far back as I can remember, anyways). During my early teenage years I began teaching myself to build simple webpages, learning TI-BASIC and writing some pretty bad games in Python.  Luckily I had the opportunity to join a CS program during high-school and even get some exposure to the industry before starting my undergraduate degree.</p>
