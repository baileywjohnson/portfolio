...
const About = ({updateParent}:any) => {
    ...
    return (
        <React.Fragment>
            ...
            <p>I've been a <b>full-stack software engineer</b> at Press Ganey (NarrativeDx/AI Solutions) since August of 2021. I graduated from Coastal Carolina University (B.S. in Computer Science) in May of 2020 and initially relocated to the Houston-area to work as a SWE at NASA's Johnson Space Center &#128640;. Since accepting my remote position with Press Ganey I've temporarily returned to South Carolina but currently have my sights set on Seattle, WA.</p>
            <p>I initially built this portfolio to compliment my resume, as somewhere I could showcase my personal projects.  What you're viewing now is the second version (source for the old version <a href="https://github.com/baileywjohnson/portfolio-old" rel="noreferrer" target="_blank">here</a>) which includes some additional content and is one of the projects I've used to sharpen my React & UI/UX-design skills.</p>
            ...
            <MyStack />
            <p>A few of the things I'd like to learn in the future are <b>Electron</b> and <b>Three.js</b>.</p>
            <h3>More About Me</h3>
            ...
            <p>While I've landed on full-stack software engineering, my interests in the CS-realm have shifted a bit over the past several years. Initially I was interested in cybersecurity, which led me to participating in CTF-style events, visiting security conferences, and eventually completing an internship with a cybersecurity/digital forensics company.  Software/web development was a bigger part of that role than expected and I was drawn to the more creative nature of it. Because of this I decided to pursue a full-time software engineering role post-undergrad and that has led me to where I am today.</p>
