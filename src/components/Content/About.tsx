...
const About = ({updateParent}:any) => {
    ...
    return (
        <React.Fragment>
            ...
            <MyStack />
            <p>What I'm most comfortable with may not always be the best tool for the job so I'm always open to learning something new if it's the right fit.</p>
            <h3>More About Me</h3>
