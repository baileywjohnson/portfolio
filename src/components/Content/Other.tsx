    ...
    return (
        <React.Fragment>
            ...
            <ul>
                ...
                <li><b>Chrome (Dev)</b>: React/Redux DevTools</li>
                <li><b>Firefox (Daily)</b>: Bitwarden, uBlock Origin</li>
                <li><b>Standard Notes</b>: Midnight Theme</li>
                <li><b>iTerm</b>: Homebrew, OhMyZsh (Cloud Theme)</li>
                <li><b>Magnet, Postman, Cyberduck, Spotify</b></li>
            </ul>

            <h3>What's On My (Virtual) Shelf  📘</h3>
            <p>Listed below are some of the books I reference pretty regularly while I'm working.</p>
            <ul>
